function [hataz,hatacr]=incremental_planli(net,maxepoch,training_x,training_y,testing_x,testing_y)
%%
% clear all;
% rand('seed', 1);
% [x,y]=arffoku('C:\Users\Melike Nur Mermer\Desktop\36uci\36uci\letter.arff');
...
hatacr(2)=1-basarili/nofsample;
%net.trainParam.epochs=3*maxepoch;
